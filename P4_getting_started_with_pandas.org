...
* Loading data
  ...
  #+begin_src  python :session P4 :exports code :results none :tangle yes
    ...
    # directory
    df = pd.read_csv('./scripts/salaries_by_college_major.csv')
  #+end_src
...
* Bar chart with error bars
  ...
  #+begin_src  python :session P4 :exports both :results file :tangle yes
        ...
        fig.tight_layout()
        fname = 'scripts/error_bar_plot.png'
        fig.savefig(fname)
        plt.show()
        fname
  #+end_src
  ...
  [[file:scripts/error_bar_plot.png]]
