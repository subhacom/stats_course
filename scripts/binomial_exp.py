...
# %%
var = sum(squared_dev) / (n - 1)
print('Variance with Bessel\'s correction', var)
print('Standard deviation', np.sqrt(var))
print('Theoretical variance: N * p * (1-p) =', N * 0.5 * 0.5)
print('Theoretical SD: sqrt(N * p * (1-p)) =', np.sqrt(N * 0.5 * 0.5))
